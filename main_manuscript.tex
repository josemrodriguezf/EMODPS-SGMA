...
Future studies should consider supply-side management strategies, such as managed aquifer recharge (\cite{alam_can_2020}) and water markets (\cite{arellano-gonzalez_adaptive_2021}) that can potentially increase the surface water availability and groundwater recovery. The results showed cropland shortages as feasible startegy that represent economic loss, however there are ongoing efforts to repurpose cropland to other uses that  Other land repurposing options can be included in  Future work can expand the area study to a the whole groundwater basin where multiple GSAs can can develop conjunct management strategies.Other sustainability metrics that are included in the state legislation can be considered to assess their trade-offs. Finally, this study used district wide performance in its formulation which can have nuances within the district due to the diversity of farm scale operation and commodities future studies can consider social metrics as equity and water affordability in its objectives definition.
