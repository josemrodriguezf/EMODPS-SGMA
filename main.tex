...
During dry periods agriculture relies on groundwater pumping to offset the lack of surface water. During dry periods groundwater pumping is used as a buffer to reduce the negative impacts of surface water shortages but that has led to overdraft (\cite{liu_groundwater_2022,lund_lessons_2018}). In the SJV there has been an expansion of perennial tree crops mainly Almonds (\cite{mall_water_2019}) which is the most important commodity by value in the region (\cite{usda_national_2020}), which acreage has increased in the last decade driven mainly by global market conditions. Although high profitable, the expansion of perennial tree crops represents a less flexible water demand to have a sustainable groundwater use and a higher risk of farmers to water shortages due to high establishment costs (\cite{qin_flexibility_2019}). Other important commodities in the region include vine, alfalfa, corn, cotton and cucumbers. 
